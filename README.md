...
<p>Our approach is centered around a modular architecture that allows for more product categories to be included. The inference process is built around a modular architecture as well thanks to <a href="https://docs.ultralytics.com/modes/">Ultralytics</a>, we allow for dynamic parameter adjustments, including confidence thresholds and Non-Maximum Suppression (NMS) settings. </p>
